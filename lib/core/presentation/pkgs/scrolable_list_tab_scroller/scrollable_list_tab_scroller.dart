...
class ScrollableListTabScroller extends StatefulWidget {
  ScrollableListTabScroller({
    ...
    @Deprecated("This code is unused and will be removed in the next release. Deprecated since >3.0.1")
...
class _DefaultHeaderWidgetState extends State<DefaultHeaderWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tabController = TabController(
      initialIndex: min(widget.selectedTabIndex.value, max(0, widget.itemCount - 1)),
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: TabBar(
        ...
        automaticIndicatorColorAdjustment: widget.tabBarProps.automaticIndicatorColorAdjustment,
