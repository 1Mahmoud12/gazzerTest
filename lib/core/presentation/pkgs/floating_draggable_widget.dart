  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        width = widget.screenWidth ?? constraints.maxWidth;
        height = widget.screenHeight ?? constraints.maxHeight;
