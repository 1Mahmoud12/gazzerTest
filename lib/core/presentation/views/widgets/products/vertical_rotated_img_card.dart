          ...
          children: [
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(prod.name, style: TStyle.primaryBold(12), overflow: TextOverflow.ellipsis),
                            ),
                          ],
                        ),
            ...
            Padding(
              ...
              child: Transform.rotate(
                ...
                child: ClipRRect(
                  borderRadius: AppConst.defaultBorderRadius,
                  child: CustomNetworkImage(prod.image, fit: BoxFit.cover, width: 95, height: 50),
                ),
              ),
            ),
