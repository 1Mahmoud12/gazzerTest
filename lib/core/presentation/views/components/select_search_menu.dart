  ...
  void didUpdateWidget(covariant SelectSearchMenu<T> oldWidget) {
    if (widget.initValue != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        controller.text = widget.initValue == null
            ? ''
            : widget.initValue!()
                  .map((e) => widget.mapper(e)?.title ?? '')
                  .join(', ');
          ...
          : () {
              ...
              showDialog(
                ...
                builder: (context) => _SelectMenu(
                  initialSelectedValues: widget.initValue == null
                      ? null
                      : widget.initValue!()
            ...
            return SizedBox(
              ...
              child: widget.isLoading
                  ...
                  : Icon(
                      ...
                      color: widget.items?.isNotEmpty == true
                          ? Colors.black
                          : Colors.grey,
                    ),
            );
