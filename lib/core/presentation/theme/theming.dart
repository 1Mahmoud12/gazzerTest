...
class AppTheme {
  ...
  static final lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleSmall: TStyle.robotBlackMedium(),
      labelLarge: TStyle.robotBlackRegular(),
      labelMedium: TStyle.robotBlackSmall(),
      labelSmall: TStyle.robotBlackThin(),
    ),
    scaffoldBackgroundColor: Co.bg,
    switchTheme: const SwitchThemeData(
      thumbColor: WidgetStateColor.fromMap({
        WidgetState.selected: Co.secondary,
        WidgetState.any: Co.purple,
      }),
  ...
  static final darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleSmall: TStyle.robotBlackMedium().copyWith(color: Co.white),
      labelLarge: TStyle.robotBlackRegular().copyWith(color: Co.white),
      labelMedium: TStyle.robotBlackSmall().copyWith(color: Co.white),
      labelSmall: TStyle.robotBlackThin().copyWith(color: Co.white),
    ),
