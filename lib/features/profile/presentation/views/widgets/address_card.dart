...
class AddressCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDarkMode ? Co.darkModeLayer : Co.lightPurple;
      ...
      child: Container(
        ...
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.data?.id == address.id &&
                snapshot.data is AddressCardErrors) {
                    ...
                    children: [
                      ...
                      if (defaultButton)
                        if (address.isDefault)
                          InkWell(
                            onTap: snapshot.data is SetDefaultLoading
                                ? null
                            ...
                            child: DecoratedBox(
                              ...
                              child: Padding(
                                ...
                                child:
                                    snapshot.data is SetDefaultLoading &&
                                        (snapshot.data! as SetDefaultLoading)
                                                .id ==
                                            address.id
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      //       TextSpan(
                                      //         text:
                                      //             '${address.provinceName}, ${address.zoneName}, ${L10n.tr().apartmentNumber} ${address.apartment}',
                                      //       ),
                                      ...
                                      //         TextSpan(
                                      //           text:
                                      //               ', ${L10n.tr().landmark} ${address.landmark}.',
                                      //         ),
                                      //     ],
                        ...
                        InkWell(
                          onTap: snapshot.data is DeleteAddressLoading
                              ...
                              : () async {
                                  ...
                                  if (res == true)
                                    bus.deleteAddress(address.id);
                                },
                          child:
                              snapshot.data is DeleteAddressLoading &&
                                  snapshot.data?.id == address.id
