        ...
        builder: (context, state) => ListView(
          ...
          children: [
            ...
            _FilterItem(
              ...
              onTap: () {
                print(state.query.searchWord);
                context.read<SearchCubit>().performSearch(
                  cubit.state.query.copyWith(sortedByRate: !state.query.sortedByRate),
                );
              },
            ),
            _FilterItem(
              ...
              onTap: () {
                context.read<SearchCubit>().performSearch(
                  cubit.state.query.copyWith(sortByDeliveryTime: !state.query.sortByDeliveryTime),
                );
              },
            ),
          ],
