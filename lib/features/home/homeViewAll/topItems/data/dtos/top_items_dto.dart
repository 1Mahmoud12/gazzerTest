...
class TopItemsDto {
  TopItemsDto({required this.status, required this.message, required this.data});
  ...
  factory TopItemsDto.fromJson(Map<String, dynamic> json) {
    return TopItemsDto(status: json['status'], message: json['message'], data: json['data'] == null ? null : TopItemsDtoData.fromJson(json['data']));
  }
...
class TopItemsDtoData {
  TopItemsDtoData({required this.entities, required this.banner});
  ...
  factory TopItemsDtoData.fromJson(Map<String, dynamic> json) {
    return TopItemsDtoData(
      entities: json['entities'] == null ? [] : List<TopItemEntity>.from(json['entities']!.map((x) => TopItemEntity.fromJson(x))),
      banner: json['banner'],
    );
  }
...
class TopItemEntity {
  TopItemEntity({required this.itemType, required this.item});

  final String? itemType;
  final TopItemData? item;

  factory TopItemEntity.fromJson(Map<String, dynamic> json) {
    return TopItemEntity(itemType: json['item_type'], item: json['item'] == null ? null : TopItemData.fromJson(json['item']));
  }

  Map<String, dynamic> toJson() => {'item_type': itemType, 'item': item?.toJson()};
}
