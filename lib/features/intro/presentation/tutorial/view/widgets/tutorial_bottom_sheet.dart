                ...
                children: [
                  ...
                  PlanAnimatedBtn(
                    onPressed: () {
                      ...
                      context.myPush(BlocProvider(create: (context) => di<LoginCubit>(), child: const LoginScreen())).then((v) {
                        isAnimating.value = true;
                      });
                    },
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: OptionBtn(
                        onPressed: () {
                          context.myPush(BlocProvider(create: (context) => di<LoginCubit>(), child: const LoginScreen()));
                        },
                        text: L10n.tr().skip,
                      ),
                    ),
