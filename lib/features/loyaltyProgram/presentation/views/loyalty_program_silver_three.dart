...
class LoyaltyProgramSilverThreeScreen extends StatefulWidget {
  const LoyaltyProgramSilverThreeScreen({super.key});

  static const route = '/loyalty-programs-silver-three';

  @override
  State<LoyaltyProgramSilverThreeScreen> createState() => _LoyaltyProgramSilverThreeScreenState();
}

class _LoyaltyProgramSilverThreeScreenState extends State<LoyaltyProgramSilverThreeScreen> {
