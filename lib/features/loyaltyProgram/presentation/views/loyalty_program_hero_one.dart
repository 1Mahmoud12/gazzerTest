...
class LoyaltyProgramHeroOneScreen extends StatefulWidget {
  const LoyaltyProgramHeroOneScreen({super.key});

  static const route = '/loyalty-programs-hero-one';

  @override
  State<LoyaltyProgramHeroOneScreen> createState() => _LoyaltyProgramHeroOneScreenState();
}

class _LoyaltyProgramHeroOneScreenState extends State<LoyaltyProgramHeroOneScreen> {
  final Color _mainColor = Co.purple;
  final Color firstTextColor = Co.white;
  final Color secondTextColor = Co.lightGrey;
  final String logoProgram = Assets.heroIc;
