...
class LoyaltyProgramWinnerTwoScreen extends StatefulWidget {
  const LoyaltyProgramWinnerTwoScreen({super.key});

  static const route = '/loyalty-programs-winner-two';

  @override
  State<LoyaltyProgramWinnerTwoScreen> createState() => _LoyaltyProgramWinnerTwoScreenState();
}

class _LoyaltyProgramWinnerTwoScreenState extends State<LoyaltyProgramWinnerTwoScreen> {
  final Color _mainColor = Co.purple600;
  final Color firstTextColor = Colors.white;
  final Color secondTextColor = Co.lightGrey;
  final String logoProgram = Assets.winnerIc;
