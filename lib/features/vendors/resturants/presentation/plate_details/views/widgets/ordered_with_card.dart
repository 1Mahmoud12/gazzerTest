                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: context.style12400.copyWith(color: Co.secondary, fontWeight: TStyle.semi),
                                  ),
                                ],
                              ),
                            ],
                          ),
                          Text(Helpers.getProperPrice(product.price), style: context.style12400.copyWith(shadows: AppDec.blackTextShadow)),
                        ],
                      ),
                    ),
                  ],
