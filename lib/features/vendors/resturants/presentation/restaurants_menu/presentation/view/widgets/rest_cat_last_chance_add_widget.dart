...
//                 },
//                 child: Image.asset(key: ValueKey(Fakers.plates[index].image), Fakers.plates[index].image, height: 110, width: 110, fit: BoxFit.cover),
//               ),
//             ),
//           ),
//           Align(
...
//                   return FadeTransition(opacity: primaryAnimation, child: child);
//                 },
//                 child: Image.asset(key: ValueKey(Fakers.plates[index].image), Fakers.plates[index].image, height: 60, width: 60, fit: BoxFit.cover),
//               ),
//             ),
//           ),
//         ],
