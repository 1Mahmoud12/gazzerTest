...
class UnScollableLTabedList extends StatefulWidget {
  ...
  @override
  State<UnScollableLTabedList> createState() => _UnScollableLTabedListState();
}

class _UnScollableLTabedListState extends State<UnScollableLTabedList> {
      ...
      tabBuilder: (context, index, active) {
        ...
        return Padding(
          ...
          child: SubCategoryItem(
            ...
            isSelected: active,
            ontap: () =>
                controller.scrollTo(index: index, duration: Durations.short1),
          ),
        );
      },
