...
class StoreMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => di<StoresMenuCubit>(param1: 2),
      child: Builder(
        builder: (context) {
          return BlocBuilder<StoresMenuCubit, StoresMenuStates>(
                        ...
                        return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              TitleWithMore(
                                title: category.name,
                                onPressed: () => StoresOfCategoryRoute(vendorId: category.id).push(context),
                              ),
                              SizedBox(
                                height: 300,
