    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const VerticalSpacing(24),
          _TopRatedComponent(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
          CategoryComponentOne(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
          CategoryComponentTwo(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
          CategoryComponentThree(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
          Padding(
          ...
          const VerticalSpacing(24),
          _CategoryComponenetFour(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
          _CategoryComponenetFive(subcat: Fakers.categoriesOfPlateentity.first, vendors: Fakers.restaurants),
          const VerticalSpacing(24),
