    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const VerticalSpacing(24),
          _TopRatedComponent(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
          CategoryComponentOne(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
          CategoryComponentTwo(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
          CategoryComponentThree(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
          Padding(
          ...
          const VerticalSpacing(24),
          _CategoryComponenetFour(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
          _CategoryComponenetFive(subcat: Fakers.fakeSubCats.first, vendors: Fakers.vendors),
          const VerticalSpacing(24),
