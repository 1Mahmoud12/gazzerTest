class ForgetPasswordData {
  ...
  final forgotPasswordSuccessJson = {'data': [], 'message': 'OTP sent successfully. Please verify your OTP.', 'status': 'success'};
  ...
  final maxAttemptsReachedErrorJson = {'message': 'You have reached the maximum number of attempts.', 'status': 'error'};

  /// JSON responses for reset password request
  final resetPasswordSuccessJson = {'data': [], 'message': 'Password reset successful! Log in with your new password.', 'status': 'success'};
  ...
  final resendOtpSuccessJson = {'data': {}, 'message': 'OTP sent successfully to your phone number', 'status': 'success'};
}
