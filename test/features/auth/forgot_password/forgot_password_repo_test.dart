...
void main() async {
  ...
  group('ForgotPasswordRepo Tests', () {
    ...
    setUp(() {
      forgotPasswordRepo = ForgotPasswordImp(apiClient, diTest<CrashlyticsRepo>());
    });
    ...
    group('ForgotPassword Function Tests', () {
      test('should return success message when forgot password request succeeds', () async {
        when(
      ...
      test('should return Error with message when phone number is not registered', () async {
        when(apiClient.post(endpoint: Endpoints.forgetPassword, requestBody: {'phone': forgetPasswordData.invalidPhone})).thenThrow(() {
    ...
    group('VerifyOtp Function Tests', () {
      test('should return success message with reset token when OTP verification succeeds', () async {
      ...
      test('should return Error when OTP verification fails with invalid OTP', () async {
        when(
          apiClient.post(
            endpoint: Endpoints.forgetPasswordVerifyOTP,
      ...
      test('should return Error when OTP verification fails due to expired OTP', () async {
        when(
          apiClient.post(
            endpoint: Endpoints.forgetPasswordVerifyOTP,
      ...
      test('should return Error when OTP verification fails due to max attempts reached', () async {
        when(
          apiClient.post(
            endpoint: Endpoints.forgetPasswordVerifyOTP,
        ...
        final result = await forgotPasswordRepo.verifyOtp(forgetPasswordData.phone, forgetPasswordData.maxAttempteddOtp);
    ...
    group('ResetPassword Function Tests', () {
      test('should return success message when password reset succeeds', () async {
        forgotPasswordRepo.resetPasswordToken = forgetPasswordData.resetToken;
        when(
          apiClient.post(
      ...
      test('should return Error when password reset fails with weak password', () async {
        forgotPasswordRepo.resetPasswordToken = forgetPasswordData.resetToken;
        when(
          apiClient.post(
            endpoint: Endpoints.resetPassword,
      ...
      test('should return Error when password reset fails with expired token', () async {
    ...
    group('Verify Repo Function Tests', () {
      group('Verify Function Tests', () {
        ...
        test('should return Error when OTP verification fails due to max attempts reached', () async {
          ...
          final result = await forgotPasswordRepo.verify(forgetPasswordData.maxAttempteddOtp, forgetPasswordData.phone);
      ...
      group('ChangePhone Function Tests', () {
        test('should throw UnimplementedError when trying to change phone', () async {
          expect(() => forgotPasswordRepo.onChangePhone(forgetPasswordData.newPhone, ''), throwsA(isA<UnimplementedError>()));
        });
      });
    });
  });
